    ...
    >
      ...
      <Section title="4. Kusurlu Hizmet / Hasar">
        <p>
          ...
          renk atması vb.) tespit ederseniz teslimden itibaren{" "}
          <strong>48 saat içinde</strong> takip sayfanızdaki telefon üzerinden
          işletmeye veya platforma bildirin. Çözüm önceliği sırasıyla: ücretsiz
          yeniden yıkama, bedel iadesi veya zararın tazminidir. Platform, çözüm
          sürecinde müşteri ile işletme arasında aracılık eder. Şoförün
          teslimde çektiği fotoğraflar ve sipariş kayıtları süreçte delil
          olarak kullanılır.
        </p>
      </Section>
