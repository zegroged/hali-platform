    ...
    >
      ...
      <Section title="Ödeme ve Faturalandırma">
        <p>
          ...
          karşılığında e-arşiv fatura düzenlenir. Ödeme, kayıt akışının
          sonunda <strong>iyzico</strong>&apos;nun güvenli ödeme sayfasında
          kredi veya banka kartıyla yapılır; kart bilgilerin bize
          ulaşmaz.
        </p>
        <p>
